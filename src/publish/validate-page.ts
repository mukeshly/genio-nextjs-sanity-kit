import type { PublishPageInput, ValidatedPublishPageInput } from "../types/publish.js";
...
export function validatePublishPageInput(input: PublishPageInput): ValidatedPublishPageInput {
